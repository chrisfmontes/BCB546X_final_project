...
pairs(log2(mircounts[,c(1:11)]+1),main="Pair-wise sample to sample counts Mo17",pch=".", cex.axis = 2.0, cex.labels = 1.5, cex.main = 2.0)
dev.off()
png(filename = "../scatter_B73.png", width = 1000, height = 1000)
pairs(log2(mircounts[,c(12:22)]+1),main="Pair-wise sample to sample counts B73",pch=".", cex.axis = 2.0, cex.labels = 1.5, cex.main = 2.0)
dev.off()
png(filename = "../scatter_Oh43.png", width = 1000, height = 1000)
pairs(log2(mircounts[,c(23:33)]+1),main="Pair-wise sample to sample counts Oh43",pch=".", cex.axis = 2.0, cex.labels = 1.5, cex.main = 2.0)
dev.off()
X11()
...
X11()
plot(B73_cold$log2FoldChange,-log(B73_cold$padj,10),main="Volcano Plot B73 cold treated vs control", ylab = "-log(padj)", xlab = "log2fold (cold/control)")
